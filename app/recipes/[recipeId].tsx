  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => {/* Add sharing options here */}}>
      ...
      {/* Recipe details */}
      <Text style={styles.details}>60min • 500 cal/serving • 3 servings</Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.ingredient}>• 3 beef bullion cubes, crushed</Text>
